    ...
    def INPUT_TYPES(self):
        ...
        return {
            "required": {
                ...
                "text_negative": ("STRING", {"default": "noisy, blurry, deformed, ugly", "multiline": True}),
                "style": (styles,),
...
class MexxSDXLPromptStylerAdvanced:
...
NODE_CLASS_MAPPINGS = {
    "MexxSDXLPromptStyler": MexxSDXLPromptStyler,
    "MexxSDXLPromptStylerAdvanced": MexxSDXLPromptStylerAdvanced,
}

NODE_DISPLAY_NAME_MAPPINGS = {
    "MexxSDXLPromptStyler": "ComfyUI Mexx Styler",
    "MexxSDXLPromptStylerAdvanced": "ComfyUI Mexx Styler Advanced",
}